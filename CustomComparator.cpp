...
// //bool mai rhta h custom comparator hmesha
//  bool myComparator(int&a , int&b){
//     //starting k do element se sorting start hota h 
//     // return a<b ; //increasing order function
//      return a>b ; //decreasing order function
//  }
